...
# amenity1.icon.attach(io: File.open("/home/dheeraj/trainub/app/assets/images/amenity_icons/kitchen.svg"), filename: amenity1.name)

# amenity2 = Amenity.create!(name: 'Private Pool')
# amenity2.icon.attach(io: File.open("/home/dheeraj/trainub/app/assets/images/amenity_icons/private_pool.svg"), filename: amenity2.name)

# amenity3 = Amenity.create!(name: 'Essentials', description: "Towels, bed shhets, soap and toilet paper")
# amenity3.icon.attach(io: File.open("/home/dheeraj/trainub/app/assets/images/amenity_icons/essentials.svg"), filename: amenity3.name)

# amenity4 = Amenity.create!(name: 'Wifi')
# amenity4.icon.attach(io: File.open("/home/dheeraj/trainub/app/assets/images/amenity_icons/wifi.svg"), filename: amenity4.name)
...
amenities_data.each do |data|
  ...
  amenity.icon.attach(io: File.open("/home/dheeraj/trainub/app/assets/images/amenity_icons/#{data[:icon]}"), filename: amenity.name)
end
...
user.picture.attach(io: pictures[0], filename: user.name)
  ...
  19.times do |i|
    ...
    user.picture.attach(io: pictures[i + 1], filename: user.name)
